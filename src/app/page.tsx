    ...
    <div className="bg-slate-50 grainy-light">
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  and that led to some pretty heavy stretchmarks on all of my
      ...
      <section>
        <MaxWidthWrapper className="py-24">
          ...
          <ul className="mx-auto mt-12 max-w-prose w-fit sm:text-lg space-y-2">
            <li>
              <Check className="text-green-600 h-5 w-5 inline mr-1.5" />
