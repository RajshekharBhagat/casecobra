...
import PhonePreview from "@/components/PhoneReview";
...
const ThankYou = () => {
  ...
  const { caseColor, configuredImageUrl } = configuration;
        ...
        <div className=" mt-10 border-t border-zinc-200">
          <div className="mt-10 flex flex-auto flex-col">
            ...
            <p className="mt-2 text-sm text-zinc-600">
              ...
              look good, but also last you for the year to come. We offer a
              5-year print guarantee: If you case isn&apos;t of the highest quality,
              we&apos;ll replace it for free.{" "}
            </p>
          </div>
        </div>
        <div className="flex space-x-6 overflow-hidden mt-4 rounded-xl bg-gray-900/5 ring-1 ring-inset ring-gray-900/10 lg:rounded-2xl select-none">
          <PhonePreview
            color={caseColor}
            configuredImage={configuredImageUrl}
          />
        </div>
        <div>
